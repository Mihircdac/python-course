...
# cdac = {'name': 'Gaurav' , 'rollno' : 1 ,'rollno' : 2}
# print("This is the roll list: ",cdac)

# #through tuple
# vjti= dict([('name','Deepak') ,( 'rollno' , 3 )])
# print("this is mumbai: ",vjti)

# bsl= dict(name = 'Sagar' , rollno = 2 )
# print("boy from bsl: ",bsl)

# student = {"Name": "Amol", "roll no": "20", "class": "diploma"}
# print("this the stuent info", student)

# student["Name"] ="ram"
# print(student)

# coep=dict([("name","ram",),("age",26)])
# print(coep)
...
# for i in range(0,no_of_students,1):
...
print("The employee id1 is " , d['employee_id']) #KeyError: 'employee_id1'
print(d.values())
print(d.keys())
print(d.items())
...
d['employee_id1']     = 12121212
print(d)

d.update({"name": "ram", "age": "26"})
print(d)
